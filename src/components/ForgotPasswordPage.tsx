      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8 animate-fade-in">
          ...
          <h1 className="text-3xl font-bold text-just-forest mb-2">
            {emailSent 
              ? smartCapitalize(language === 'es' ? 'revisa tu correo' : 'check your email', 'title', language)
              : smartCapitalize(language === 'es' ? 'restablecer contraseña' : 'reset password', 'title', language)
            }
          </h1>
          <p className="text-just-hunter text-lg">
            {emailSent 
              ? smartCapitalize(language === 'es' ? 'te hemos enviado un enlace de restablecimiento' : 'we\'ve sent you a password reset link', 'sentence', language)
          ...
          {!emailSent ? (
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder={smartCapitalize(language === 'es' ? 'ingresa tu correo electrónico' : 'enter your email address', 'sentence', language)}
                    required
                  />
                </div>
            ...
            <div className="text-center space-y-6">
              ...
              <div className="space-y-3">
                ...
                >
                  {smartCapitalize(language === 'es' ? 'enviar otro correo' : 'send another email', 'title', language)}
                </button>
